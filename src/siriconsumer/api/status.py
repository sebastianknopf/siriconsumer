...
<meta http-equiv="refresh" content="5"><title>SIRI Consumer Status</title><style>
...
<section><h2>Subscriptions</h2><div class="table-wrap"><table><thead><tr><th>ID</th><th>Profile</th><th>Version</th><th>mTLS</th><th>Termination Time</th><th>Status</th><th>Last Data Received</th><th>Last Heartbeat</th><th class="numeric">Spool Size</th><th>Logging</th><th>Actions</th></tr></thead><tbody>{table_body}</tbody></table></div><footer>Spool Size shows payload bytes / data files only, excluding metadata. Page refreshes every 5 seconds.</footer></section></main>
<script>
